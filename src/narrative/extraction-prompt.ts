...
export function buildNarrativeExtractionPrompt(
    ...
    JSON.stringify(
      {
        ...
        endingAnalysis: {
          finalParagraph: "She could use it. It would save her client. It would also end her career.",
  ...
  return [
    ...
    "",
    "### 11. Ending Analysis",
    "- Analyze the story's FINAL paragraph (the last 2-3 sentences).",
    "- finalParagraph: quote the last paragraph verbatim (or last 2-3 sentences if the final paragraph is short).",
    "- endsOnConcreteImagery: does the ending use specific, sensory details (objects, sounds, physical sensations)?",
    "- endsOnAction: does the ending show a character DOING something (physical action, not thinking)?",
    "- summarizesTheme: does the ending restate or summarize the story's theme in abstract/general terms?",
    "- authorIntrusion: does the narrator step outside the story to comment, editorialize, or lecture?",
    '- CRITICAL: The strongest endings land on a concrete image or action, trusting the reader to feel the theme. Endings that summarize ("She had become a symbol of...") or editorialize ("Time had taught her that...") are a craft weakness — they tell the reader what to feel instead of letting them feel it.',
    loreSection,
    beatsSection,
    "",
    "## Draft to Analyze",
